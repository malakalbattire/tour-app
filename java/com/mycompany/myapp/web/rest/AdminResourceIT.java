...
class AdminResourceIT {
    ...
    public static Admin createEntity(EntityManager em) {
        Admin admin = new Admin().payment(DEFAULT_PAYMENT).accept(DEFAULT_ACCEPT);
        return admin;
    }
    ...
    public static Admin createUpdatedEntity(EntityManager em) {
        Admin admin = new Admin().payment(UPDATED_PAYMENT).accept(UPDATED_ACCEPT);
        return admin;
    }
    ...
    void createAdmin() throws Exception {
        ...
        assertThat(testAdmin.getPayment()).isEqualTo(DEFAULT_PAYMENT);
        assertThat(testAdmin.getAccept()).isEqualTo(DEFAULT_ACCEPT);
    }
    ...
    void getAllAdmins() throws Exception {
        ...
        restAdminMockMvc
            ...
            .andExpect(jsonPath("$.[*].accept").value(hasItem(DEFAULT_ACCEPT)));
    }
    ...
    void getAdmin() throws Exception {
        ...
        restAdminMockMvc
            ...
            .andExpect(jsonPath("$.accept").value(DEFAULT_ACCEPT));
    }
    ...
    void putNewAdmin() throws Exception {
        ...
        updatedAdmin.payment(UPDATED_PAYMENT).accept(UPDATED_ACCEPT);
        ...
        Admin testAdmin = adminList.get(adminList.size() - 1);
        assertThat(testAdmin.getPayment()).isEqualTo(UPDATED_PAYMENT);
        assertThat(testAdmin.getAccept()).isEqualTo(UPDATED_ACCEPT);
    }
    ...
    void partialUpdateAdminWithPatch() throws Exception {
        ...
        partialUpdatedAdmin.payment(UPDATED_PAYMENT);
    ...
    void fullUpdateAdminWithPatch() throws Exception {
        ...
        partialUpdatedAdmin.payment(UPDATED_PAYMENT).accept(UPDATED_ACCEPT);
